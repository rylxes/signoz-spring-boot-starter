...
class SigNozLoggingAutoConfigurationTest {
    ...
    @Test
    void maskingRegistryUsesCustomMaskedFields() {
    ...
    @Test
    void logbackConfigurerBeanIsCreated() {
        runner.run(ctx -> {
