...
class HttpLoggingFilterTest {
    ...
    @Test
    public void getRequestIsLogged() throws Exception {
    ...
    @Test
    public void statusCodeIncludedInLog() throws Exception {
        mockMvc.perform(get("/test"))
                .andExpect(status().isOk())
                .andExpect(content().string("ok"));
    ...
    @Test
    public void excludedPathIsNotLogged() throws Exception {
    ...
    @Test
    public void loggedRequestBodyLimitDoesNotTruncateControllerInput() throws Exception {
        listAppender.list.clear();
